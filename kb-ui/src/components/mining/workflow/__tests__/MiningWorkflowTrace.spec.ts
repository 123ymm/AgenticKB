...
function frozenTrace(): RunTrace {
  return {
    ...
    ontology_proposed_candidates: 0, entity_pending_mentions: 0, entity_count: 0, relation_count: 0,
    ...
    stage_events: [], documents: [], asset_counts: { entities: 0, relations: 0 }, build_id: null,
  }
}
